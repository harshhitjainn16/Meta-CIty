...
contract BuildingNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor()
        ERC721("MetaCity Building", "MCBUILDING")
        Ownable(msg.sender)
    {}
    ...
    function mintBuilding(
        ...
        uint256 sustainabilityScore = calculateInitialSustainability(
            buildingType
        );
    ...
    function calculateInitialSustainability(
        BuildingType buildingType
    ...
    function calculateInitialEconomicValue(
        BuildingType buildingType
    ) internal pure returns (uint256) {
